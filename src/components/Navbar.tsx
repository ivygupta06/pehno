...
import { Sparkles, Heart, Shirt, Palette, Settings, User as UserIcon, LogOut, Key } from 'lucide-react';
            ...
            {currentUser ? (
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-xs font-semibold text-pastel-charcoal max-w-[80px] truncate hidden sm:inline">
                ...
                {/* Profile Dropdown */}
                {profileDropdown && (
                  <div className="absolute right-0 mt-2 w-52 bg-white rounded-2xl border border-pastel-sand shadow-soft-lg p-2.5 z-50 animate-fadeIn">
                    <div className="px-2 py-1.5 border-b border-pastel-sand/50 mb-1.5">
                      <p className="text-xs font-bold text-pastel-charcoal truncate">{currentUser.name}</p>
                      <p className="text-[10px] text-pastel-muted truncate">{currentUser.email}</p>
